...
fn one_bit_empty() {
    let data = [];
    let unpacked = unpack(&data, 0, 0, One);
    assert_eq!(unpacked, []);
}
...
fn one_bit_single_byte() {
    let data = [0b11100101];
    let unpacked = unpack(&data, 8, 8, One);
...
fn one_bit_multiple_bytes() {
    ...
    let unpacked = unpack(&data, 16, 16, One);
...
fn one_bit_multiple_bytes_with_remainder() {
    ...
    let unpacked = unpack(&data, 18, 18, One);
...
fn one_bit_multiple_bytes_with_multiple_remainders() {
    ...
    let unpacked = unpack(&data, 36, 18, One);
    assert_eq!(unpacked, [
...
fn two_bit_empty() {
    let data = [];
    let unpacked = unpack(&data, 0, 0, Two);
    assert_eq!(unpacked, []);
}
...
fn two_bit_single_byte() {
    let data = [0b11100101];
    let unpacked = unpack(&data, 4, 4, Two);
...
fn two_bit_multiple_bytes() {
    let data = [0b11100101, 0b00011010];
    let unpacked = unpack(&data, 8, 8, Two);
...
fn two_bit_multiple_bytes_with_remainder() {
    let data = [0b11100101, 0b00011010, 0b10000000];
    let unpacked = unpack(&data, 9, 9, Two);
...
fn two_bit_multiple_bytes_with_multiple_remainders() {
    ...
    let unpacked = unpack(&data, 18, 9, Two);
    assert_eq!(unpacked, [
        3, 2, 1, 1, 0, 1, 2, 2, 2,
        3, 2, 1, 1, 0, 1, 2, 2, 2
    ]);
...
fn four_bit_empty() {
    let data = [];
    let unpacked = unpack(&data, 0, 0, Four);
    assert_eq!(unpacked, []);
}
...
fn four_bit_single_byte() {
    let data = [0b11100101];
    let unpacked = unpack(&data, 2, 2, Four);
...
fn four_bit_multiple_bytes() {
    let data = [0b11100101, 0b00011010];
    let unpacked = unpack(&data, 4, 4, Four);
...
fn four_bit_multiple_bytes_with_remainder() {
    let data = [0b11100101, 0b00011010, 0b10000000];
    let unpacked = unpack(&data, 5, 5, Four);
...
fn four_bit_multiple_bytes_with_multiple_remainders() {
    ...
    let unpacked = unpack(&data, 10, 5, Four);
    assert_eq!(unpacked, [
        14, 5, 1, 10, 8,
        14, 5, 1, 10, 8
    ]);
...
fn eight_bit_empty() {
    let data = [];
    let unpacked = unpack(&data, 0, 0, Eight);
    assert_eq!(unpacked, []);
}
...
fn eight_bit_single_byte() {
    let data = [100];
    let unpacked = unpack(&data, 1, 1, Eight);
...
fn eight_bit_multiple_bytes() {
    let data = [100, 200];
    let unpacked = unpack(&data, 2, 2, Eight);
...
fn sixteen_bit_empty() {
    let data = [];
    let unpacked = unpack(&data, 0, 0, Sixteen);
    assert_eq!(unpacked, []);
}
...
fn sixteen_bit_single_byte() {
    let data = [0x64, 0x00];
    let unpacked = unpack(&data, 1, 1, Sixteen);
    assert_eq!(unpacked, [100]);
}
...
fn sixteen_bit_multiple_bytes() {
    ...
    let unpacked = unpack(&data, 2, 2, Sixteen);
    assert_eq!(unpacked, [100, 200]);
}
...
fn sixteen_bit_precision_loss() {
    ...
    let unpacked = unpack(&data, 4, 4, Sixteen);
